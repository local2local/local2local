#!/bin/bash
# --- L2LAAF RELAY v4.0 ---
# Target: logic_payload.txt (The paste destination)
...
if [ ! -f "$PAYLOAD_FILE" ]; then
    ...
    echo "Action: Copy content from Gemini logic_payload.js and paste into scripts/logic_payload.txt in Cursor."
    exit 1
fi

echo "--- L2LAAF RELAY v4.0 ---"
