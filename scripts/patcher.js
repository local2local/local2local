...
/**
 * L2LAAF Logic Patcher v4.1 (NASA Standard)
 * Hardened against null-byte injection and token corruption.
 */
...
try {
    ...
    let count = 0;
    console.log('--- L2LAAF PATCHER v4.1 ---');
    ...
    while ((match = regex.exec(input)) !== null) {
        ...
        // Root Cause Fix 1: Reconstruct template literals using safe tokens
        content = content.replace(/_BT_/g, '`');

        // Root Cause Fix 2: Scrub Null Bytes and non-UTF8 noise
